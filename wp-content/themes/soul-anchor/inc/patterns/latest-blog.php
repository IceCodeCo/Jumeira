...
<!-- wp:group {"className":"post-main-area","style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"}},"border":{"radius":"5px","color":"#e7e7e7","width":"1px"},"shadow":"var:preset|shadow|deep"},"layout":{"inherit":false}} -->
<div class="wp-block-group post-main-area has-border-color" style="border-color:#e7e7e7;border-width:1px;border-radius:5px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px;box-shadow:var(--wp--preset--shadow--deep)"><!-- wp:post-title {"isLink":true,"style":{"typography":{"fontSize":"22px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"soul-anchor-Poppins"} /-->
...
<!-- wp:post-date {"style":{"color":{"text":"#159bca"},"elements":{"link":{"color":{"text":"#159bca"}}}}} /--></div>
<!-- /wp:group -->
