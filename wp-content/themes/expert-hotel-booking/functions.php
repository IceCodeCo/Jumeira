...
/* Excerpt Limit Begin */
function expert_hotel_booking_string_limit_words($string, $word_limit) {
...
function expert_hotel_booking_sanitize_select( $input, $setting ) {
...
// Sanitize the input
function expert_hotel_booking_sanitize_sidebar_position( $input ) {
...
if (!function_exists('expert_hotel_booking_custom_shop_loop_columns')) {
    function expert_hotel_booking_custom_shop_loop_columns() {
        ...
        $columns = get_theme_mod('expert_hotel_booking_custom_shop_per_columns', 3);
        return $columns;
    }
}
...
if (!function_exists('expert_hotel_booking_custom_shop_per_page')) {
    function expert_hotel_booking_custom_shop_per_page($products_per_page) {
        // Retrieve the number of products per page from theme customizer setting (default: 9)
        $products_per_page = get_theme_mod('expert_hotel_booking_custom_shop_product_per_page', 9);
