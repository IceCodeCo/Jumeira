<?php 
  $expert_hotel_booking_tourist = get_theme_mod('expert_hotel_booking_tourist_setting','1');
	...
	<section id="tourist-section" class="py-5">
		<div class="container"> 
			...
			for ($s = 1; $s <= 6; $s++) {
				...
				if (!empty($expert_hotel_booking_mod) && $expert_hotel_booking_mod != 'page-none-selected') {
